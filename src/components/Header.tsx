...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#2563eb] border-b border-white/10 shadow-lg">
      <div className="container mx-auto px-4 py-4 md:py-5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <a href="https://www.fasuleducacional.edu.br/posgraduacao/cursos" target="_blank" rel="noopener noreferrer">
            <Button
              variant="default"
              className="bg-accent text-accent-foreground hover:bg-accent/85 font-semibold rounded-full text-sm md:text-base px-4 md:px-5 py-2.5"
            >
              COMECE AGORA
            </Button>
          </a>
      ...
      {/* Mobile menu sidebar */}
      <div
        className={`md:hidden fixed top-0 right-0 h-full w-72 bg-[#2563eb] z-50 transform transition-transform duration-300 ease-in-out ${
